export const SideBarAbstaction = ({title, prefix, mainID, firstCategories}) => ({
  extend: ['Flex'],
  props: {
    flow: 'y',
  },
...
// export const SideBarAbstaction = ({ title, mainID, firstCategories }) => ({
//   extend: ['Flex'],
//   props: {
//     flow: 'y',
//   },
...
//       const icon = document.getElementById('main-top-icon');

//       if (mainDropdown.contains(e.target)) {
//         firstCategories.forEach(({ id }) => {
//           const topDropdown = document.getElementById(id);
//           toggleDropdown(topDropdown);
//         });
//       }
//       if (mainDropdown.contains(e.target)) {
...
//   $topCategoryCollection: () => firstCategories.map((res) => category(res)),
// });

// const category = ({ topCat, id, url, subCategories }) => ({
//   extend: 'Flex',
//   attr: {
//     id: id,
//     'aria-expanded': 'false',
...
//       const SubCategoryListWrap = subList.querySelector('.sub-category-dropdown');
//       const icon = subList.querySelector('.sub-icon');
//       if (subList.contains(e.target)) {
//         toggleDropdown(SubCategoryListWrap);
//       }
...
//     extend: 'Flex',
//     attr: {
//       class: 'sub-category-dropdown', 'aria-expanded': 'false',},
//     props: {
//       flexDirection: 'column',
//       borderLeft: '1px solid grey',
//       maxHeight: '0',
...
//       visibility: 'hidden',
//     },
//     $subCategoryCollection: () =>subCategories.map((subCat) => subCategoriesComponent(subCat)),
//     $subCategoryCollection: () =>subCategories.map((subCat) => subCategoriesComponent(subCat)),
//   },
// });
...
//   on: {
//     click: (e) => {
//       const mainDropdown = document.querySelector('.main-category-dropdown');
//       const icon = document.querySelector('.main-top-icon');
